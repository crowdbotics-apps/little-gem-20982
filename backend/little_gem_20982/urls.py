"""little_gem_20982 URL Configuration
...
admin.site.site_header = "little gem"
admin.site.site_title = "little gem Admin Portal"
admin.site.index_title = "little gem Admin"

# swagger
api_info = openapi.Info(
    title="little gem API",
    default_version="v1",
    description="API documentation for little gem App",
)
